		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lovercraft Collection",
									"targetURL": "#lvcrftlovecraftcollection-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lvcrftlovecraftcollection-display": {
								"semanticObject": "lvcrftlovecraftcollection",
								"action": "display",
								"description": "A Catalogue showing Lovecraft Mitology related books. ",
								"title": "Lovercraft Collection",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lvcrft.lovecraftcollection",
									"url": sap.ui.require.toUrl("lvcrft/lovecraftcollection")
								}
							}
						}
					}
